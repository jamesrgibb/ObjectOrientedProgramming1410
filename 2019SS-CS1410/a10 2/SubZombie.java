...
public class SubZombie extends Zombie {
	private boolean isColliding;

	public SubZombie(Double startingPosition, Double initHitbox, BufferedImage img, int health, int coolDown,
	...
	public void attack(Actor other) {
		if (other instanceof Plant || other instanceof Home)
			super.attack(other);
	}
